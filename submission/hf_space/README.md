...
- [Fine-tuned SFT model on HF Hub](https://huggingface.co/rescommons/aegis-sft-e4b-merged-v4)
- [LiteRT-LM model on HF Hub](https://huggingface.co/rescommons/gemma4-e4b-toolcalling-litertlm-v2)
